...
import { coursesManifest, getCourse, getLessonsByCourse } from '@/lib/lessonsManifest';
...
export const CoursesPage: FC = () => {
  ...
  const courses = coursesManifest.map((c) => ({
    ...getCourse(c.id, currentLang)!,
    lessons: getLessonsByCourse(c.id, currentLang),
  }));
